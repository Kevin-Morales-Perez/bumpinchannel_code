function [p_star] = pressure_corr(rho,p_m,d_eps_vec,eps_vec,normf_vec,u_vec,d_k)
%Pressure correction
...
%epsA_vec  vector wich joins nodes P to A [1,2]
